CREATE TABLE `ANINAC` (
    ...
    `ANINACFEC` date NOT NULL COMMENT 'NACIMIENTO',
...
CREATE TABLE `ANINACA` (
    ...
    `ANINACAFECOLD` date NULL COMMENT 'NACIMIENTO OLD',
    ...
    `ANINACAFECNEW` date NULL COMMENT 'NACIMIENTO NEW',
...
CREATE TRIGGER `ANINACDLT` 
  ...
  FOR EACH ROW 
    INSERT INTO `ANINACA` (`ANINACAMET`, `ANINACAEMP`, `ANINACAUSU`, `ANINACAFEC`, `ANINACADIP`, `ANINACACODOLD`, `ANINACAESCOLD`, `ANINACAPECOLD`, `ANINACAANCOLD`, `ANINACAFECOLD`, `ANINACAOBSOLD`)
    VALUES ('DELETE', OLD.`ANINACAEM`, OLD.`ANINACAUS`, NOW(), OLD.`ANINACAIP`, OLD.`ANINACCOD`, OLD.`ANINACESC`, OLD.`ANINACPEC`, OLD.`ANINACANC`, OLD.`ANINACFEC`, OLD.`ANINACOBS`);

CREATE TRIGGER `ANINACINS` 
  AFTER INSERT ON `ANINAC` 
  FOR EACH ROW 
    INSERT INTO `ANINACA` (`ANINACAMET`, `ANINACAEMP`, `ANINACAUSU`, `ANINACAFEC`, `ANINACADIP`, `ANINACACODNEW`, `ANINACAESCNEW`, `ANINACAPECNEW`, `ANINACAANCNEW`, `ANINACAFECNEW`, `ANINACAOBSNEW`)
    VALUES ('INSERT', NEW.`ANINACAEM`, NEW.`ANINACAUS`, NOW(), NEW.`ANINACAIP`, NEW.`ANINACCOD`, NEW.`ANINACESC`, NEW.`ANINACPEC`, NEW.`ANINACANC`, NEW.`ANINACFEC`, NEW.`ANINACOBS`);

CREATE TRIGGER `ANINACUPD` 
  AFTER UPDATE ON `ANINAC` 
  FOR EACH ROW 
    INSERT INTO `ANINACA` (`ANINACAMET`, `ANINACAEMP`, `ANINACAUSU`, `ANINACAFEC`, `ANINACADIP`, `ANINACACODOLD`, `ANINACAESCOLD`, `ANINACAPECOLD`, `ANINACAANCOLD`, `ANINACAFECOLD`, `ANINACAOBSOLD`, `ANINACACODNEW`, `ANINACAESCNEW`, `ANINACAPECNEW`, `ANINACAANCNEW`, `ANINACAFECNEW`, `ANINACAOBSNEW`)
    VALUES ('UPDATE', NEW.`ANINACAEM`, NEW.`ANINACAUS`, NOW(), NEW.`ANINACAIP`, OLD.`ANINACCOD`, OLD.`ANINACESC`, OLD.`ANINACPEC`, OLD.`ANINACANC`, OLD.`ANINACFEC`, OLD.`ANINACOBS`, NEW.`ANINACCOD`, NEW.`ANINACESC`, NEW.`ANINACPEC`, NEW.`ANINACANC`, NEW.`ANINACFEC`, NEW.`ANINACOBS`);