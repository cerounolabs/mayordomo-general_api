CREATE TABLE `ESTPOT` (
    ...
    `ESTPOTTPC` int(9) NOT NULL COMMENT 'TIPO PASTURA',
    ...
    `ESTPOTHEC` varchar(100) COLLATE utf8_spanish_ci NULL COMMENT 'HECTÁREA',
...
CREATE TABLE `ESTPOTA` (
    ...
    `ESTPOTATPCOLD` int(9) NULL COMMENT 'TIPO PASTURA OLD',
    ...
    `ESTPOTAHECOLD` varchar(100) COLLATE utf8_spanish_ci NULL COMMENT 'HECTÁREA OLD',
    ...
    `ESTPOTATPCNEW` int(9) NULL COMMENT 'TIPO PASTURA NEW',
    ...
    `ESTPOTAHECNEW` varchar(100) COLLATE utf8_spanish_ci NULL COMMENT 'HECTÁREA NEW',
...
CREATE TRIGGER `ESTPOTDLT` 
  ...
  FOR EACH ROW 
    INSERT INTO `ESTPOTA` (`ESTPOTAMET`, `ESTPOTAEMP`, `ESTPOTAUSU`, `ESTPOTAFEC`, `ESTPOTADIP`, `ESTPOTACODOLD`, `ESTPOTAECCOLD`, `ESTPOTATPCOLD`, `ESTPOTAESCOLD`, `ESTPOTASECOLD`, `ESTPOTANOMOLD`, `ESTPOTAHECOLD`, `ESTPOTAOBSOLD`)
    VALUES ('DELETE', OLD.`ESTPOTAEM`, OLD.`ESTPOTAUS`, NOW(), OLD.`ESTPOTAIP`, OLD.`ESTPOTCOD`, OLD.`ESTPOTECC`, OLD.`ESTPOTTPC`, OLD.`ESTPOTESC`, OLD.`ESTPOTSEC`, OLD.`ESTPOTNOM`, OLD.`ESTPOTHEC`, OLD.`ESTPOTOBS`);

CREATE TRIGGER `ESTPOTINS` 
  AFTER INSERT ON `ESTPOT` 
  FOR EACH ROW 
    INSERT INTO `ESTPOTA` (`ESTPOTAMET`, `ESTPOTAEMP`, `ESTPOTAUSU`, `ESTPOTAFEC`, `ESTPOTADIP`, `ESTPOTACODNEW`, `ESTPOTAECCNEW`, `ESTPOTATPCNEW`, `ESTPOTAESCNEW`, `ESTPOTASECNEW`, `ESTPOTANOMNEW`, `ESTPOTAHECNEW`, `ESTPOTAOBSNEW`)
    VALUES ('INSERT', NEW.`ESTPOTAEM`, NEW.`ESTPOTAUS`, NOW(), NEW.`ESTPOTAIP`, NEW.`ESTPOTCOD`, NEW.`ESTPOTECC`, NEW.`ESTPOTTPC`, NEW.`ESTPOTESC`, NEW.`ESTPOTSEC`, NEW.`ESTPOTNOM`, NEW.`ESTPOTHEC`, NEW.`ESTPOTOBS`);

CREATE TRIGGER `ESTPOTUPD` 
  AFTER UPDATE ON `ESTPOT` 
  FOR EACH ROW 
    INSERT INTO `ESTPOTA` (`ESTPOTAMET`, `ESTPOTAEMP`, `ESTPOTAUSU`, `ESTPOTAFEC`, `ESTPOTADIP`, `ESTPOTACODOLD`, `ESTPOTAECCOLD`, `ESTPOTATPCOLD`, `ESTPOTAESCOLD`, `ESTPOTASECOLD`, `ESTPOTANOMOLD`, `ESTPOTAHECOLD`, `ESTPOTAOBSOLD`, `ESTPOTACODNEW`, `ESTPOTAECCNEW`, `ESTPOTATPCNEW`, `ESTPOTAESCNEW`, `ESTPOTASECNEW`, `ESTPOTANOMNEW`, `ESTPOTAHECNEW`, `ESTPOTAOBSNEW`)
    VALUES ('UPDATE', NEW.`ESTPOTAEM`, NEW.`ESTPOTAUS`, NOW(), NEW.`ESTPOTAIP`, OLD.`ESTPOTCOD`, OLD.`ESTPOTECC`, OLD.`ESTPOTTPC`, OLD.`ESTPOTESC`, OLD.`ESTPOTSEC`, OLD.`ESTPOTNOM`, OLD.`ESTPOTHEC`, OLD.`ESTPOTOBS`, NEW.`ESTPOTCOD`, NEW.`ESTPOTECC`, NEW.`ESTPOTTPC`, NEW.`ESTPOTESC`, NEW.`ESTPOTSEC`, NEW.`ESTPOTNOM`, NEW.`ESTPOTHEC`, NEW.`ESTPOTOBS`);
