...
CREATE TRIGGER `ESTFICDLT` 
  ...
  FOR EACH ROW 
    INSERT INTO `ESTFICA` (`ESTFICAMET`, `ESTFICAEMP`, `ESTFICAUSU`, `ESTFICAFEC`, `ESTFICADIP`, `ESTFICACODOLD`, `ESTFICAECCOLD`, `ESTFICATECOLD`, `ESTFICATFCOLD`, `ESTFICAPECOLD`, `ESTFICADICOLD`, `ESTFICANOMOLD`, `ESTFICATHEOLD`, `ESTFICATPOOLD`, `ESTFICACO1OLD`, `ESTFICACO2OLD`, `ESTFICACO3OLD`, `ESTFICAOBSOLD`)
                  VALUES ('DELETE', OLD.`ESTFICAEM`, OLD.`ESTFICAUS`, NOW(), OLD.`ESTFICAIP`, OLD.`ESTFICCOD`, OLD.`ESTFICECC`, OLD.`ESTFICTEC`, OLD.`ESTFICTFC`, OLD.`ESTFICPEC`, OLD.`ESTFICDIC`, OLD.`ESTFICNOM`, OLD.`ESTFICTHE`, OLD.`ESTFICTPO`, OLD.`ESTFICCO1`, OLD.`ESTFICCO2`, OLD.`ESTFICCO3`, OLD.`ESTFICOBS`);

CREATE TRIGGER `ESTFICINS` 
  AFTER INSERT ON `ESTFIC` 
  FOR EACH ROW 
    INSERT INTO `ESTFICA` (`ESTFICAMET`, `ESTFICAEMP`, `ESTFICAUSU`, `ESTFICAFEC`, `ESTFICADIP`, `ESTFICACODNEW`, `ESTFICAECCNEW`, `ESTFICATECNEW`, `ESTFICATFCNEW`, `ESTFICAPECNEW`, `ESTFICADICNEW`, `ESTFICANOMNEW`, `ESTFICATHENEW`, `ESTFICATPONEW`, `ESTFICACO1NEW`, `ESTFICACO2NEW`, `ESTFICACO3NEW`, `ESTFICAOBSNEW`)
                  VALUES ('INSERT', NEW.`ESTFICAEM`, NEW.`ESTFICAUS`, NOW(), NEW.`ESTFICAIP`, NEW.`ESTFICCOD`, NEW.`ESTFICECC`, NEW.`ESTFICTEC`, NEW.`ESTFICTFC`, NEW.`ESTFICPEC`, NEW.`ESTFICDIC`, NEW.`ESTFICNOM`, NEW.`ESTFICTHE`, NEW.`ESTFICTPO`, NEW.`ESTFICCO1`, NEW.`ESTFICCO2`, NEW.`ESTFICCO3`, NEW.`ESTFICOBS`);

CREATE TRIGGER `ESTFICUPD` 
  AFTER UPDATE ON `ESTFIC` 
  FOR EACH ROW 
    INSERT INTO `ESTFICA` (`ESTFICAMET`, `ESTFICAEMP`, `ESTFICAUSU`, `ESTFICAFEC`, `ESTFICADIP`, `ESTFICACODOLD`, `ESTFICAECCOLD`, `ESTFICATECOLD`, `ESTFICATFCOLD`, `ESTFICAPECOLD`, `ESTFICADICOLD`, `ESTFICANOMOLD`, `ESTFICATHEOLD`, `ESTFICATPOOLD`, `ESTFICACO1OLD`, `ESTFICACO2OLD`, `ESTFICACO3OLD`, `ESTFICAOBSOLD`, `ESTFICACODNEW`, `ESTFICAECCNEW`, `ESTFICATECNEW`, `ESTFICATFCNEW`, `ESTFICAPECNEW`, `ESTFICADICNEW`, `ESTFICANOMNEW`, `ESTFICATHENEW`, `ESTFICATPONEW`, `ESTFICACO1NEW`, `ESTFICACO2NEW`, `ESTFICACO3NEW`, `ESTFICAOBSNEW`)
                  VALUES ('UPDATE', NEW.`ESTFICAEM`, NEW.`ESTFICAUS`, NOW(), NEW.`ESTFICAIP`, OLD.`ESTFICCOD`, OLD.`ESTFICECC`, OLD.`ESTFICTEC`, OLD.`ESTFICTFC`, OLD.`ESTFICPEC`, OLD.`ESTFICDIC`, OLD.`ESTFICNOM`, OLD.`ESTFICTHE`, OLD.`ESTFICTPO`, OLD.`ESTFICCO1`, OLD.`ESTFICCO2`, OLD.`ESTFICCO3`, OLD.`ESTFICOBS`, NEW.`ESTFICCOD`, NEW.`ESTFICECC`, NEW.`ESTFICTEC`, NEW.`ESTFICTFC`, NEW.`ESTFICPEC`, NEW.`ESTFICDIC`, NEW.`ESTFICNOM`, NEW.`ESTFICTHE`, NEW.`ESTFICTPO`, NEW.`ESTFICCO1`, NEW.`ESTFICCO2`, NEW.`ESTFICCO3`, NEW.`ESTFICOBS`);
