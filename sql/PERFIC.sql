...
CREATE TRIGGER `PERFICINS` 
  ...
  FOR EACH ROW 
    INSERT INTO `PERFICA` (`PERFICAMET`, `PERFICAEMP`, `PERFICAUSU`, `PERFICAFEC`, `PERFICADIP`, `PERFICACODNEW`, `PERFICAECCNEW`, `PERFICATPCNEW`, `PERFICATDCNEW`, `PERFICANOMNEW`, `PERFICADOCNEW`, `PERFICATELNEW`, `PERFICAMAINEW`, `PERFICAOBSNEW`)
                  VALUES ('INSERT', NEW.`PERFICAEM`, NEW.`PERFICAUS`, NOW(), NEW.`PERFICAIP`, NEW.`PERFICCOD`, NEW.`PERFICECC`, NEW.`PERFICTPC`, NEW.`PERFICTDC`, NEW.`PERFICNOM`, NEW.`PERFICDOC`, NEW.`PERFICTEL`, NEW.`PERFICMAI`, NEW.`PERFICOBS`);
