...
CREATE TRIGGER `ANIDONDLT`
  ...
  FOR EACH ROW
    ...
    VALUES ('DELETE', OLD.`ANIDONAEM`, OLD.`ANIDONAUS`, NOW(), OLD.`ANIDONAIP`, OLD.`ANIDONCOD`, OLD.`ANIDONTDC`, OLD.`ANIDONESC`, OLD.`ANIDONANC`, OLD.`ANIDONFEC`, OLD.`ANIDONOBS`);
...
CREATE TRIGGER `ANIDONINS`
  ...
  FOR EACH ROW
    ...
    VALUES ('INSERT', NEW.`ANIDONAEM`, NEW.`ANIDONAUS`, NOW(), NEW.`ANIDONAIP`, NEW.`ANIDONCOD`, NEW.`ANIDONTDC`, NEW.`ANIDONESC`, NEW.`ANIDONANC`, NEW.`ANIDONFEC`, NEW.`ANIDONOBS`);
...
CREATE TRIGGER `ANIDONUPD`
  ...
  FOR EACH ROW
    ...
    VALUES ('UPDATE', NEW.`ANIDONAEM`, NEW.`ANIDONAUS`, NOW(), NEW.`ANIDONAIP`, OLD.`ANIDONCOD`, OLD.`ANIDONTDC`, OLD.`ANIDONESC`, OLD.`ANIDONANC`, OLD.`ANIDONFEC`, OLD.`ANIDONOBS`, NEW.`ANIDONCOD`, NEW.`ANIDONTDC`, NEW.`ANIDONESC`, NEW.`ANIDONANC`, NEW.`ANIDONFEC`, NEW.`ANIDONOBS`);