CREATE TABLE `ANIDON` (
    ...
    `ANIDONTDC` char(1) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL COMMENT 'TIPO',
...
CREATE TABLE `ANIDONA` (
    ...
    `ANIDONATDCOLD` char(1) CHARACTER SET utf8 COLLATE utf8_spanish_ci NULL COMMENT 'TIPO OLD',
    ...
    `ANIDONATDCNEW` char(1) CHARACTER SET utf8 COLLATE utf8_spanish_ci NULL COMMENT 'TIPO NEW',
