...
CREATE TRIGGER `ESTUBDINS` 
  ...
  FOR EACH ROW 
    INSERT INTO `ESTUBDA` (`ESTUBDAMET`, `ESTUBDAEMP`, `ESTUBDAUSU`, `ESTUBDAFEC`, `ESTUBDADIP`, `ESTUBDCODNEW`, `ESTUBDECCNEW`, `ESTUBDTCCNEW`, `ESTUBDTSCNEW`, `ESTUBDUBCNEW`, `ESTUBDCANNEW`, `ESTUBDOBSNEW`)
...
CREATE TRIGGER `ESTUBDUPD` 
  ...
  FOR EACH ROW
    INSERT INTO `ESTUBDA` (`ESTUBDAMET`, `ESTUBDAEMP`, `ESTUBDAUSU`, `ESTUBDAFEC`, `ESTUBDADIP`, `ESTUBDCODOLD`, `ESTUBDECCOLD`, `ESTUBDTCCOLD`, `ESTUBDTSCOLD`, `ESTUBDUBCOLD`, `ESTUBDCANOLD`, `ESTUBDOBSOLD`, `ESTUBDCODNEW`, `ESTUBDECCNEW`, `ESTUBDTCCNEW`, `ESTUBDTSCNEW`, `ESTUBDUBCNEW`, `ESTUBDCANNEW`, `ESTUBDOBSNEW`)
