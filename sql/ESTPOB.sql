CREATE TABLE `ESTPOB` (
    ...
    `ESTPOBTCC` int(9) NOT NULL COMMENT 'CATEGORIA',
    ...
    `ESTPOBPES` decimal(10, 3) NULL COMMENT 'PESO PROMEDIO',
...
CREATE TABLE `ESTPOBA` (
    ...
    `ESTPOBATCCOLD` int(9) NULL COMMENT 'CATEGORIA OLD',
    ...
    `ESTPOBAPESOLD` decimal(10, 3) NULL COMMENT 'PESO PROMEDIO OLD',
    ...
    `ESTPOBATCCNEW` int(9) NULL COMMENT 'CATEGORIA NEW',
    ...
    `ESTPOBAPESNEW` decimal(10, 3) NULL COMMENT 'PESO PROMEDIO NEW',
...
ALTER TABLE `ESTPOB` ADD KEY `ESTPOBTCC` (`ESTPOBTCC`);
ALTER TABLE `ESTPOB` ADD CONSTRAINT `FK_ESTPOBTCC` FOREIGN KEY (`ESTPOBTCC`) REFERENCES `mayordomo_default`.`DOMFIC` (`DOMFICCOD`);
...
CREATE TRIGGER `ESTPOBDLT` 
  ...
  FOR EACH ROW 
    INSERT INTO `ESTPOBA` (`ESTPOBAMET`, `ESTPOBAEMP`, `ESTPOBAUSU`, `ESTPOBAFEC`, `ESTPOBADIP`, `ESTPOBACODOLD`, `ESTPOBATOCOLD`, `ESTPOBATRCOLD`, `ESTPOBATCCOLD`, `ESTPOBATSCOLD`, `ESTPOBAESCOLD`, `ESTPOBAPECOLD`, `ESTPOBACANOLD`, `ESTPOBAPESOLD`, `ESTPOBAOBSOLD`)
    VALUES ('DELETE', OLD.`ESTPOBAEM`, OLD.`ESTPOBAUS`, NOW(), OLD.`ESTPOBAIP`, OLD.`ESTPOBCOD`, OLD.`ESTPOBTOC`, OLD.`ESTPOBTRC`, OLD.`ESTPOBTCC`, OLD.`ESTPOBTSC`, OLD.`ESTPOBESC`, OLD.`ESTPOBPEC`, OLD.`ESTPOBCAN`, OLD.`ESTPOBPES`, OLD.`ESTPOBOBS`);

CREATE TRIGGER `ESTPOBINS` 
  AFTER INSERT ON `ESTPOB` 
  FOR EACH ROW 
    INSERT INTO `ESTPOBA` (`ESTPOBAMET`, `ESTPOBAEMP`, `ESTPOBAUSU`, `ESTPOBAFEC`, `ESTPOBADIP`, `ESTPOBACODNEW`, `ESTPOBATOCNEW`, `ESTPOBATRCNEW`, `ESTPOBATCCNEW`, `ESTPOBATSCNEW`, `ESTPOBAESCNEW`, `ESTPOBAPECNEW`, `ESTPOBACANNEW`, `ESTPOBAPESNEW`, `ESTPOBAOBSNEW`)
    VALUES ('INSERT', NEW.`ESTPOBAEM`, NEW.`ESTPOBAUS`, NOW(), NEW.`ESTPOBAIP`, NEW.`ESTPOBCOD`, NEW.`ESTPOBTOC`, NEW.`ESTPOBTRC`, NEW.`ESTPOBTCC`, NEW.`ESTPOBTSC`, NEW.`ESTPOBESC`, NEW.`ESTPOBPEC`, NEW.`ESTPOBCAN`, NEW.`ESTPOBPES`, NEW.`ESTPOBOBS`);

CREATE TRIGGER `ESTPOBUPD` 
  AFTER UPDATE ON `ESTPOB` 
  FOR EACH ROW 
    INSERT INTO `ESTPOBA` (`ESTPOBAMET`, `ESTPOBAEMP`, `ESTPOBAUSU`, `ESTPOBAFEC`, `ESTPOBADIP`, `ESTPOBACODOLD`, `ESTPOBATOCOLD`, `ESTPOBATRCOLD`, `ESTPOBATCCOLD`, `ESTPOBATSCOLD`, `ESTPOBAESCOLD`, `ESTPOBAPECOLD`, `ESTPOBACANOLD`, `ESTPOBAPESOLD`, `ESTPOBAOBSOLD`, `ESTPOBACODNEW`, `ESTPOBATOCNEW`, `ESTPOBATRCNEW`, `ESTPOBATCCNEW`, `ESTPOBATSCNEW`, `ESTPOBAESCNEW`, `ESTPOBAPECNEW`, `ESTPOBACANNEW`, `ESTPOBAPESNEW`, `ESTPOBAOBSNEW`)
    VALUES ('UPDATE', NEW.`ESTPOBAEM`, NEW.`ESTPOBAUS`, NOW(), NEW.`ESTPOBAIP`, OLD.`ESTPOBCOD`, OLD.`ESTPOBTOC`, OLD.`ESTPOBTRC`, OLD.`ESTPOBTCC`, OLD.`ESTPOBTSC`, OLD.`ESTPOBESC`, OLD.`ESTPOBPEC`, OLD.`ESTPOBCAN`, OLD.`ESTPOBPES`, OLD.`ESTPOBOBS`, NEW.`ESTPOBCOD`, NEW.`ESTPOBTOC`, NEW.`ESTPOBTRC`, NEW.`ESTPOBTCC`, NEW.`ESTPOBTSC`, NEW.`ESTPOBESC`, NEW.`ESTPOBPEC`, NEW.`ESTPOBCAN`, NEW.`ESTPOBPES`, NEW.`ESTPOBOBS`);
