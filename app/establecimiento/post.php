<?php
    ...
    $app->post('/v1/establecimiento/601', function($request) {
        ...
        $val06      = $request->getParsedBody()['persona_completo'];
        $val07      = $request->getParsedBody()['persona_documento'];
        $val08      = $request->getParsedBody()['persona_codigo_sitrap'];
        $val09      = $request->getParsedBody()['persona_codigo_sigor'];
        $val10      = $request->getParsedBody()['persona_telfono'];
        $val11      = $request->getParsedBody()['persona_email'];
