<?php
    $app->post('/v1/senacsa/600', function($request) {
        ...
        if (isset($val01) && isset($val02) && isset($val03) && isset($val07) && isset($val08) && isset($val09) && isset($val10)) {
            ...
            try {
                ...
                $stmtSENACSA->execute([$val01, $val02, $val03, $val04, $val05, $val06, $val07, $val08, $val09, $val10]); 
                
                header("Content-Type: application/json; charset=utf-8");
                $json       = json_encode(array('code' => 200, 'status' => 'ok', 'message' => 'Success INSERT', 'codigo' => $connSENACSA->lastInsertId()), JSON_UNESCAPED_UNICODE | JSON_NUMERIC_CHECK | JSON_PRESERVE_ZERO_FRACTION);
