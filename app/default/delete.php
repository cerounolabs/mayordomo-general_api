<?php
    ...
    $app->delete('/v1/default/040/{dominio}/{codigo1}/{codigo2}/{codigo3}', function($request) {
        require __DIR__.'/../../src/connect.php';
        ...
        $val04      = $request->getParsedBody()['tipo_estado_codigo'];
        $val05      = $request->getParsedBody()['tipo_dominio1_codigo'];
        $val06      = $request->getParsedBody()['tipo_dominio2_codigo'];
        $val07      = $request->getParsedBody()['tipo_dominio'];
        $val08      = $request->getParsedBody()['tipo_observacion'];

        $aud01      = $request->getParsedBody()['tipo_empresa'];
        $aud02      = $request->getParsedBody()['tipo_usuario'];
        $aud03      = $request->getParsedBody()['tipo_fecha_hora'];
        $aud04      = $request->getParsedBody()['tipo_ip'];
